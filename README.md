...
1. View of Expo App
 ...
 <image src="./Devs/assets/screenshot.png" width="250" height="500">

2. Live View

 <video width="250" height="500" controls>
 <source src="./Devs/assets/devs1.gif" type="video/gif">
 </video>
    <br>
    <br>
 <video width="250" height="500" controls>
 <source src="./Devs/assets/devs1.mp4" type="video/mp4">
 </video>
    <br>
    <br>
 <video width="250" height="500" controls>
 <source src="./Devs/assets/Devs.webm" type="video/webm">
 </video>
